...
class BaseDataSeeder extends Seeder
{
    ...
    {
        DB::unprepared("
            INSERT INTO produtos_base (prod_cod, prod_nome, prod_cat, prod_subcat, prod_desc, prod_fab, prod_mod, prod_cor, prod_peso, prod_larg, prod_alt, prod_prof, prod_und, prod_atv, prod_dt_cad) VALUES
        ...
        DB::unprepared("
            INSERT INTO precos_base (prc_cod_prod, prc_valor, prc_moeda, prc_desc, prc_acres, prc_promo, prc_dt_ini_promo, prc_dt_fim_promo, prc_dt_atual, prc_origem, prc_tipo_cli, prc_vend_resp, prc_obs, prc_status) VALUES
